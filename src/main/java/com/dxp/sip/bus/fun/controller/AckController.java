 ...
 * @date 2020/8/14
 */
public class AckController extends AbstractMsgProcessor {
        private static final InternalLogger LOGGER = InternalLoggerFactory.getInstance(AckController.class);
        ...
        public void handler(FullSipRequest request, ChannelHandlerContext channel) throws DocumentException {
            ...
            String type = headers.get(SipHeaderNames.CONTENT_TYPE);
                ...
                LOGGER.info("ack: {}", request.content().toString(CharsetUtils.US_ASCII));
