...
public class DefaultSipRequestAndResponseDecoderTest {
    ...
    public void testReceiveRegister() {
        ...
        byte[] data1 = ("REGISTER sip:192.168.30.183:5060 SIP/2.0" + CRLF +
                "Via: SIP/2.0/UDP 192.168.30.183:5061;rport;branch=z9hG4bK2995420819" + CRLF +
        ...
        byte[] data2 = ("SIP/2.0 401 Unauthorized" + CRLF +
                "Via: SIP/2.0/UDP 192.168.30.183:5061;rport=5061;branch=z9hG4bK2995420819" + CRLF +
                "From: <sip:35010401401127000000@3501040140>;tag=4112720925" + CRLF +
